...
//			hemail.setCharset(sendMail.getCharSet());
...
//
//			// 获取模板
//			template = freeMarkerConfig.getTemplate(sendMail.getTemplateFilePath(),new Locale("Zh_cn"), "UTF-8");
//			// 模板内容转换为string
...
//		try {
//			HtmlEmail hemail = new HtmlEmail();
//			hemail.setHostName(getHost(sendMail.getFrom()));
//			hemail.setSmtpPort(getSmtpPort(sendMail.getFrom()));
//			hemail.setCharset(sendMail.getCharSet());
//			hemail.addTo(sendMail.getToMailAddr());
//			if(StringUtils.isBlank(sendMail.getFromName())){
//				hemail.setFrom(sendMail.getFrom(),sendMail.getFromName());
...
//		private String charSet = "UTF-8"; //邮件编码
...
//
//	  String[] toMailAddr = new String[]{"shil20@vanke.com","844391561@qq.com"};
//	  String subject = "测试邮件";
//	  String message = "测试邮件<br/><a href=\\\"http://www.google.cn\\\">谷歌</a><br/>";
//	  try {
//	  	File attachmentFile = new File("E:\\work\\logs\\aiot-manager-web\\aiot-manager-web.log");
//		SendMail sendMail = new SendMail.Builder("844391561@qq.com")
//			  .subject(subject)
//				.message(message)
//				.toMailAddr(toMailAddr)
//				.fromPwd("rxkijztdoiiibeef")
