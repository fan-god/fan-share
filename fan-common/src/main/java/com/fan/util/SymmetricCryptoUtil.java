...
//    	String dataStr = "aiot123";
    	String dataStr = "admin123";
    	byte[] encryptAES = encryptAES(DEFAULT_KEY_AES, EncodeUtil.decodeBase64(dataStr));
    	System.out.println(EncodeUtil.encodeBase64(encryptAES));
    }
}
